...
// Ошибка Cannot read property 'createDOMPins' of undefined скорее всего возникает,
// когда map.js выполняется быстрее, чем прийдет результат запроса XMLHttpRequest
// не сделал обработку ошибок при сохранении на сервер
// с адресом не понятно - полное обозначенние из данных использовать?